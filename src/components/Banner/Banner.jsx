        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl ">
          ...
          <div data-aos="zoom-in" className="h-full flex items-center ">
            <img
              src={data.image}
              alt=""
              className="scale-105 w-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-cover "
            />
          </div>
          {/* third column  */}
          <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
            <p data-aos="zoom-in" className="font-bold text-xl ">{data.title2} </p>
            <p data-aos="fade-up" className="text-sm  ">{data.title3} </p>
